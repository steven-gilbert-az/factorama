...
namespace factorama
{
    ...
    InverseRangeVariable::InverseRangeVariable(int variable_id, const Eigen::Vector3d& origin_pos_W,
                                               const Eigen::Vector3d& bearing_W, double initial_range)
        : origin_pos_W_(origin_pos_W)
        , bearing_W_(bearing_W.normalized())
    {
        id_ = variable_id;
        // Store inverse range
