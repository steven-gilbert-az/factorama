...
namespace factorama
{
    ...
    public:
        ...
        VariableType::VariableTypeEnum type() const override { return VariableType::plane; }
         ...
         */
        const Eigen::Vector3d& unit_vector() const { return unit_vector_; }

        /**
         * @brief Get signed distance from origin
         * @return Distance from origin to plane
         */
        double distance_from_origin() const { return distance_from_origin_; }
        ...
        std::shared_ptr<Variable> clone() const override { return std::make_shared<PlaneVariable>(*this); }
