...
namespace factorama
{
    ...
    public:
         ...
         */
        PosePositionPriorFactor(int id, PoseVariable *pose, const Eigen::Vector3d& pos_prior, double sigma = 1.0);
    ...
    public:
         ...
         */
        PoseOrientationPriorFactor(int id, PoseVariable *pose, const Eigen::Matrix3d& dcm_CW_prior, double sigma = 1.0);
